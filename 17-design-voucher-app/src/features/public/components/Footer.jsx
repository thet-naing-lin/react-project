...
const Footer = () => {
  return (
    <footer className="bg-white antialiased dark:bg-gray-800 mt-auto">
          ...
          <div className="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
            ...
            <div className="mt-6 w-full md:mt-8 lg:mt-0 lg:max-w-lg">
              <div className="space-y-5 rounded-lg bg-gray-50 p-6 dark:bg-gray-700">
                <a
                  href="#"
                  className="text-base font-medium text-teal-700 underline hover:no-underline dark:text-teal-500"
                >
                ...
                <form action="#">
                  <div className="items-end space-y-4 sm:flex sm:space-y-0">
                    <div className="relative mr-3 w-full sm:w-96 lg:w-full">
                      ...
                      <input
                        className="block w-full rounded-lg border border-gray-300 bg-white p-3 text-sm text-gray-900 focus:border-teal-500 focus:ring-teal-500 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-teal-500 dark:focus:ring-teal-500 sm:w-96 lg:w-full"
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-full cursor-pointer rounded-lg bg-teal-700 px-5 py-3 text-center text-sm font-medium text-white hover:bg-teal-800 focus:ring-4 focus:ring-teal-300 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800"
                      >
                        Subscribe
                      </button>
                    </div>
