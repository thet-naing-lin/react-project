      ...
      <form id="createRecordForm" onSubmit={handleSubmit(handleSaleForm)}>
        <div className="grid grid-cols-5 gap-3 bg-teal-900 p-5 rounded shadow">
          ...
          <div className="col-span-1">
            <button
              type="submit"
              className=" sm:w-14 md:w-24 lg:w-32 h-[70px] text-sm flex justify-center items-center text-white bg-gradient-to-r from-teal-500 via-teal-600 to-teal-700 hover:bg-gradient-to-br  dark:focus:ring-teal-800  font-medium rounded-md text-center"
            >
              Add Product
            </button>
          </div>
